...
extern "C" {
  ...
  void MR_EdgeIDs_R1(MRegion_ptr r, int *nre, int *redgeids) {
    *nre = 0;    
    MSTK_Report("MR_EdgeIDs_R1","NOT IMPLEMENTED - Edges are not persistent entities in R1 representation",MSTK_ERROR);
  }
