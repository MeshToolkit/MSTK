...
extern "C" {
  ...
  void MF_EdgeIDs_R1(MFace_ptr f, int dir, int startvertid, int *nfe,
                     int *fedgeids) {
    *nfe = 0;
    MSTK_Report("MF_EdgeIDs_R1","NOT IMPLEMENTED - No persistent edges in representation",MSTK_WARN);
  }
